...
class Purchase extends CI_Controller
{
    ...
    public function getPurchases(){
        ...
        if(isset($data->purchaseType) && $data->purchaseType != ''){
            $clauses .= " and pm.purchase_type = '$data->purchaseType'";
        }
        ...
        $purchases = $this->db->query("
            ...
            where pm.PurchaseMaster_BranchID = ? 
            and pm.status = 'a'
    ...
    public function addPurchase()
    {
        ...
        try{
            ...
            $purchase = array(
                ...
                'status' => 'a',
                'purchase_type' => $data->purchase->purchase_type,
                'AddBy' => $this->session->userdata("FullName"),
                'AddTime' => date('Y-m-d H:i:s'),
            ...
            foreach($data->cartProducts as $product){
                ...
                if($data->purchase->purchase_type != 'pending'){
