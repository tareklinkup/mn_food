...
class Reports extends CI_Controller {
    ...
    public function branchWiseReport(){
        $data['title'] = "Brach wise Report";
        $data['content'] = $this->load->view('Administrator/reports/branch_wise_report', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
    public function getBranchWiseReport(){
        $data = json_decode($this->input->raw_input_stream);
        $clause = "";
        if(isset($data->branchId) && $data->branchId != "" && $data->branchId != null && $data->branchId != 'All')
            $clause .="WHERE br.brunch_id = '$data->branchId'";
