...
class User_management extends CI_Controller {
    ...
    public function user_Insert()  {
		...
		$data = array(
			...
			"godown"                 => $this->input->post('godown', TRUE),
    ...
    public function edit($id) {
        ...
        $query = $this->db->query("
            ...
            FROM tbl_user 
            left join tbl_brunch on tbl_brunch.brunch_id=tbl_user.userBrunch_id 
            left join tbl_brunch as g on g.brunch_id=tbl_user.godown 
            WHERE tbl_user.User_SlNo = '$id'
        ");
