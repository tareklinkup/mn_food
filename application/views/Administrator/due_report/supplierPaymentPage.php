				...
				<div class="row">
					...
					<div class="col-md-5">
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" step="0.001" class="form-control" v-model="payment.discount_amount" required>
							</div>
						</div>
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" step="0.001" class="form-control" v-model="payment.SPayment_amount" required>
							</div>
						</div>
						<div class="form-group">
	...
	new Vue({
		...
		methods:{
			...
			saveSupplierPayment(){
				...
				this.payment.SPayment_amount = +this.payment.SPayment_amount + +this.payment.discount_amount;
