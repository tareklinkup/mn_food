				...
				<div class="row">
					<div class="col-md-5 col-md-offset-1">
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<select class="form-control" v-model="customerType" v-on:change="onChangeCustomerType">
					...
					<div class="col-md-5">
						...
						<div class="form-group">
							<label class="col-md-4 control-label">Transaction By</label>
							<label class="col-md-1">:</label>
							<div class="col-md-7">
						...
						<div class="form-group">
							...
							<label class="col-md-1">:</label>
							<div class="col-md-7">
								<input type="number" class="form-control" v-model="payment.discount_amount" required>
							</div>
						</div>
						<div class="form-group">
...
<script>
	...
	new Vue({
		...
		data(){
			return {
				...
				columns: [
                    ...
                    { label: 'Transaction By', field: 'employee_name', align: 'center' },
		...
		methods:{
			...
			getCustomers(){
				axios.post('/get_customers', {customerType: this.customerType}).then(res => {
			...
			saveCustomerPayment(){
				...
				this.payment.employee_id = this.selectedEmployee == null ? null : this.selectedEmployee.Employee_SlNo;

				this.payment.CPayment_amount = +this.payment.CPayment_amount + +this.payment.discount_amount;
			...
			async editPayment(payment){
				...
				this.selectedEmployee = this.employees.find(employee => employee.Employee_SlNo == payment.employee_id);
			},
