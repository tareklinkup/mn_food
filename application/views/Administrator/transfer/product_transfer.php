                            ...
                            <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <v-select v-bind:options="branches" v-model="selectedBranch" label="Brunch_name" v-bind:style="{display: branches.length > 0 ? '' : 'none'}" @input="getGodowns()"></v-select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-4">Godown to</label>
                                    <div class="col-md-8">
                                        <v-select v-bind:options="godowns" v-model="selectedGodown" label="Brunch_name"></v-select>
                                    </div>
                                </div>
                            </div>
    ...
    new Vue({
        ...
        methods: {
            ...
            async getGodowns() {
                ...
                if(branchId == 0 || branchId == null) return;

                await axios.post('/get_godowns', {branchId: branchId}).then(res => {
            ...
            saveProductTransfer(){
                ...
                // if(this.selectedGodown == null){
                //     alert("Select Godown");
                //     return;
                // }
                
                this.transfer.godown_id = this.selectedGodown == null ? 0 : this.selectedGodown.brunch_id;
            ...
            async getTransfer() {
                ...
                this.selectedGodown = this.godowns.find(g => g.brunch_id == transfer.godown_id);
