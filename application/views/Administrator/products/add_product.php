		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-6">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control" v-model="product.Product_Name" placeholder="Product name" required>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					<label class="control-label col-md-4">Convert To:</label>
					<div class="col-md-7">
						<div class="row">
							<div class="col-md-6">
								<select class="form-control" style="padding: 1px;" v-model="product.convert_name">
							...
							<label class="control-label col-md-2 text-right">Qty:</label>
							<div class="col-md-4">
			...
			<div class="col-md-6">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control" v-model="product.Product_Purchase_Rate" placeholder="Purchase rate" required>
					</div>
				</div>
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<input type="text" class="form-control" v-model="product.Product_SellingPrice" placeholder="Sale rate" required>
					</div>
				</div>
