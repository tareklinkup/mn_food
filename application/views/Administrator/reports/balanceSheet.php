	...
	new Vue({
		...
		methods: {
			...
			async getPurchases() {
				...
				await axios.post('/get_material_purchase', this.filter)
					.then(res => {
						let purchases = res.data.purchases.map(purchase => {
							return {
								PurchaseMaster_InvoiceNo: purchase.invoice_no,
								PurchaseMaster_OrderDate: purchase.purchase_date,
								Supplier_Name: purchase.supplier_name,
								PurchaseMaster_PaidAmount: purchase.paid
							}
						})
