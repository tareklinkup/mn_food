...
<div id="userAccess">
    ...
    <div class="row" id="accessRow">
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="sales">
                    ...
                    <li><input type="checkbox" class="access" value="order_record" v-model="access"> Order Record</li>
                    ...
                    <li><input type="checkbox" class="access" value="empolyee_wise_collection_report" v-model="access"> Employee wise payment report</li>
                </ul>
            </div>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                <strong>User Change Rate</strong>
                <ul>
                    <li><input type="checkbox" class="access" value="userChangeRate" v-model="access"> User Change Sale Rate</li>
                </ul>
            </div>
        </div>
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="hrPayroll">
                    <li><input type="checkbox" class="access" value="salaryGenerate" v-model="access"> Salary Generate</li>
                    <li><input type="checkbox" class="access" value="employeePayment" v-model="access"> Employee Payment</li>
                    ...
                    <li><input type="checkbox" class="access" value="salary_payment_report" v-model="access"> Employee Payment Report</li>
                    <li><input type="checkbox" class="access" value="employee_ladger" v-model="access"> Employee Ledger</li>
                </ul>
            </div>
            <div class="group">
                <input type="checkbox" id="production" class="group-head" @click="onClickGroupHeads"> <strong>Production</strong>
                <ul ref="production">
                    <li><input type="checkbox" class="access" value="recipe_entry" v-model="access"> Recipe Entry</li>
                    <li><input type="checkbox" class="access" value="production" v-model="access"> Production Entry</li>
                    <li><input type="checkbox" class="access" value="productions" v-model="access"> Production Record</li>
                    <li><input type="checkbox" class="access" value="material_purchase" v-model="access"> Material Purchase</li>
                    <li><input type="checkbox" class="access" value="material_purchase_record" v-model="access"> Purchase Record</li>
                    <li><input type="checkbox" class="access" value="materials" v-model="access"> Material Entry</li>
                    <li><input type="checkbox" class="access" value="material_list" v-model="access"> Material List</li>
                    <li><input type="checkbox" class="access" value="material_damage" v-model="access"> Damage Materials</li>
                    <li><input type="checkbox" class="access" value="material_stock" v-model="access"> Material Stock</li>
                    <li><input type="checkbox" class="access" value="material_ledger" v-model="access"> Material Ledger</li>
                </ul>
            </div>
        </div>
        <div class="col-md-3">
