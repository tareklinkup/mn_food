                            ...
                            <div class="table-responsive">
                                <table style="color:#000;margin-bottom: 0px;">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="form-group">
                                                <label class="col-sm-12 control-label no-padding-right">Purchaser
                                                    Type</label>
                                                <div class="col-sm-12">
                                                    <select v-model="purchase.purchase_type" class="form-control"
                                                        style="padding: 0;">
                                                        <option value="pending">Chalan</option>
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <input type="button" class="btn btn-success" value="Purchase"
                                                        ...
                                                        style="background:#000;color:#fff;padding:3px;margin-right: 15px;">
                                                    <input type="button" class="btn btn-info"
                                                        onclick="window.location = '<?php echo base_url(); ?>purchase'"
                                                        value="New Purchase"
                                                        style="background:#000;color:#fff;padding:3px;">
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
