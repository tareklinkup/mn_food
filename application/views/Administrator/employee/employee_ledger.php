		...
		<div class="col-md-12">
			<div class="table-responsive" id="reportContent">
				<div style="display:none;" v-bind:style="{display: payments.length > 0 && reportType == 'records' ? '' : 'none'}">
					<h3 style="text-align:center;">Employee Ledger</h3>
					<table class="table table-bordered table-condensed">
						...
						<!-- <tfoot>
							<tr style="font-weight:bold;">
								...
								<td style="text-align:right;">{{ payments.reduce((prev, curr) => { return prev + parseFloat(curr.paid)}, 0).toFixed(2) }}</td>
							</tr>
						</tfoot> -->
					</table>
				</div>
	...
	new Vue({
		...
		methods: {
			...
			getEmployeePayments() {
				...
				// }
				axios.post('/get_employee_payment_ledger', data)
					.then(res => {
