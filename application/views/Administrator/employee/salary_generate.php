                ...
                <table class="table table-bordered table-condensed">
                    ...
                    <tbody>
                        <tr v-for="(sal, index) in salary">
                            ...
                            <td>
                                <input style="text-align: center;width: 120px;" @input="calculateTotal(index)" type="text" v-model.number="sal.bonus">
                            </td>
                            <td>
    ...
    new Vue({
        ...
        methods: {
            ...
            calculateTotal(index) {
                this.salary[index].total_amount = (parseFloat(this.salary[index].salary_range) + parseFloat(this.salary[index].bonus)) - (parseFloat(this.salary[index].leave_deduction))
