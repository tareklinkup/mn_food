		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom: 15px;">
			<div class="col-md-5 col-md-offset-1">
				<div class="form-group clearfix">
					<label class="col-sm-4 control-label no-padding-right"> Payment For </label>
					<div class="col-sm-7">
				...
				<div class="form-group">
					...
					<div class="col-md-7">
						<v-select v-bind:options="employees" label="display_name" v-model="selectedEmployee" @input="getEmployeeDue"></v-select>
					</div>
				...
				<!-- <div class="form-group">
					...
					<div class="col-md-7">
						<v-select v-bind:options="months" label="month_name" v-model="selectedMonth" @input="getEmployeeDue"></v-select>
					</div>
				</div> -->
		...
		methods: {
			...
			getEmployeeDue() {
				...
				axios.post('/get_employee_due', data).then(res => {
					if (this.payment.employee_payment_id == '') {
						this.dueAmount = res.data;
					} else {
						this.dueAmount = +res.data + +this.payment.payment_amount;

					}
				})
			},
			getPayments() {
				axios.post('/get_employee_payments').then(res => {
