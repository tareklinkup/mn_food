...
<div class="col-sm-12" style="width:500px;height:200px;">
	...
	<h4 style="margin-top:20px;"> Are you sure !!! You want to access this godown ? </h4>
	</div>
...
<script type="text/javascript">
	function Submitdata(){
		...
		if(succes == ""){
			...
			var urldata = "<?php echo base_url();?>Administrator/login/godown_branch_access_main_admin";
			$.ajax({
				type: "POST",
				url: urldata,
				data: inputdata,
