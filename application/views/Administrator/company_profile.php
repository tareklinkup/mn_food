...
<div class="col-xs-12">
	...
	<div class="col-sm-4 col-sm-offset-1">
		...
		<div class="control-group" style="margin-top:30px;">
		<label class="col-sm-12 control-label bolder blue">Show Due Option</label>
		<div class="radio">
			<label>
				<input name="is_show_due_option" id="is_show_due_option"  type="checkbox" value="1" <?php if($selected->is_show_due_option==1){ echo "checked"; } ?>  class="ace" />
				<span class="lbl"> Show Due</span>
			</label>
		</div>
	</div>
	</div>
...
<script type="text/javascript">
    function Employee_submit(){
		...
		var is_show_due_option=$('input[name=is_show_due_option]:checked').val();
		//alert(inpt);
        if(Company_name == ""){
        ...
        var Description=encodeURIComponent(Description);
          ...
          fd.append('inpt',inpt );
          fd.append('is_show_due_option',is_show_due_option );
