    ...
    <div class="col-xs-12">
        ...
        <div class="form-horizontal">
            <div class="col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <select class="chosen-select form-control" name="Brunch" id="Brunch" data-placeholder="Choose a Brunch...">
                            ...
                            <?php
                            $sql = $this->db->query("SELECT * FROM tbl_brunch where is_godown = false order by Brunch_name asc ");
                            $row = $sql->result();
                            foreach($row as $row){ ?>
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" for="Brunch"> Select Godown </label>
                    <label class="col-sm-1 control-label">:</label>
                    <div class="col-sm-6">
                        <?php
                            // echo "<pre>";
                            ...
                            // exit;
                        ?>
                        <select class="chosen-select form-control" name="godown" id="godown" data-placeholder="Choose a godown...">
                            <option value="<?php echo $selected->godown_id; ?>"><?php echo $selected->godown_name; ?></option>
                            <?php
                            $sql = $this->db->query("SELECT * FROM tbl_brunch where is_godown = true order by Brunch_name asc ");
                            $row = $sql->result();
                            foreach($row as $row){ ?>
                                <option value="<?php echo $row->brunch_id; ?>"><?php echo $row->Brunch_name; ?></option>
                            <?php } ?>
...
<script type="text/javascript">
    function Updatesubmit(){
        ...
        // if(godown==""){
        //     $("#godown").css("border-color","red");
        //     return false;
        // }else{
        //     $("#godown").css("border-color","green");
        // }
        var id= $("#id").val();
        var oldpassword= $("#oldpassword").val();

        var inputdata = 'id='+id+'&username='+username+'&user_email='+user_email+'&rePassword='+rePassword+'&txtFirstName='+txtFirstName+'&Brunch='+Brunch+'&type='+type+'&oldpassword='+oldpassword+'&godown='+godown;
