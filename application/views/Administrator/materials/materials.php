            ...
            <form id="materialForm" class="form-horizontal" v-on:submit.prevent="saveMaterial">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="code" id="code" v-model="material.code" class="form-control"
                                placeholder="Material Id" disabled="disabled">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <template scope="{ row }">
                        <tr>
                            ...
                            <td>
                                ...
                                <button class="button" v-bind:class="{active: row.status == 1}"
