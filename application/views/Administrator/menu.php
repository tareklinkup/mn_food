...
$activeGodown = $this->session->userdata('active_godown');
...
<?php } elseif ($module == 'Administration') { ?>
	<ul class="nav nav-list">
		...
		<?php if ((array_search("sms", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) && !$activeGodown) : ?>
			<li class="">
			...
			<?php if (!$activeGodown) { ?>
				<li class="">
					...
					<ul class="submenu">
						...
						<?php endif; ?>
						<?php if (array_search("godown", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
							<li class="">
								<a href="<?php echo base_url(); ?>godown">
									<i class="menu-icon fa fa-caret-right"></i>
									Add Godown
								</a>
								<b class="arrow"></b>
...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if ((array_search("sales/product", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) && !$activeGodown) : ?>
			<li class="">
		...
		<?php endif; ?>
		<?php if ((array_search("order_entry", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) && !$activeGodown) : ?>
			<li class="">
		...
		<?php endif; ?>
		<?php if ((array_search("order_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) && !$activeGodown) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>order_record">
					<i class="menu-icon fa fa-usd"></i>
		...
		<?php if ((array_search("sales/service", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) && !$activeGodown) : ?>
			<li class="">
		...
		<?php if ((array_search("salesReturn", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) && !$activeGodown) : ?>
			<li class="">
		...
		<?php if ((array_search("salesrecord", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) && !$activeGodown) : ?>
			<li class="">
		...
		<?php endif; ?>
		<?php if ((array_search("quotation", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) && !$activeGodown) : ?>
			<li class="">
			...
			<?php if (!$activeGodown) { ?>
				<li class="">
					...
					<ul class="submenu">
						...
						<?php endif; ?>
						<?php if (array_search("empolyee_wise_collection_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
							<li class="">
								<a href="<?php echo base_url(); ?>empolyee_wise_collection_report">
									<i class="menu-icon fa fa-caret-right"></i>
									Employee Wise Payment Report
								</a>
								<b class="arrow"></b>
							</li>
						<?php endif; ?>
...
<?php } elseif ($module == 'PurchaseModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("purchase_chalan", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>purchase_chalan">
					<i class="menu-icon fa fa-car"></i>
					<span class="menu-text"> Chalan Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		<?php if (array_search("purchase_chalan_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>purchase_chalan_record">
					<i class="menu-icon fa fa-car"></i>
					<span class="menu-text"> Chalan Record </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
...
<?php } elseif ($module == 'ProductionModule') { ?>
	<ul class="nav nav-list">
		...
		<?php endif; ?>
		<?php if (array_search("material_ledger", $access) > -1  || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>material_ledger">
					<i class="menu-icon fa fa-th-list"></i>
					<span class="menu-text"> Meterial Ledger </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
...
<?php } elseif ($module == 'HRPayroll') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("salaryGenerate", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>salaryGenerate">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Salary Generate </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("employeePayment", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="">
				<a href="<?php echo base_url(); ?>employeePayment">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Employee Payment </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (
			...
			<li class="">
				...
				<ul class="submenu">
					...
					<?php if (array_search("employee_ladger", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="">
							<a href="<?php echo base_url(); ?>employee_ladger">
								<i class="menu-icon fa fa-caret-right"></i>
								Employee Ledger
							</a>
							<b class="arrow"></b>
