...
$route['godownAccess/(:any)'] = 'Administrator/Login/godown_access/$1';
...
$route['print_all_sales_invoice/(:any)/(:any)/(:any)/(:any)/(:any)'] = 'Administrator/Sales/printAllSalesInvoice/$1/$2/$3/$4/$5';
...
$route['godown'] = 'Administrator/Page/addGodown';
...
$route['get_godowns'] = 'Administrator/Page/getGodowns';
...
$route['employeePayment'] = 'Administrator/Employee/employeePayment';
...
$route['employee_ladger'] = 'Administrator/Employee/employeeLadger';
$route['get_employee_payment_ledger'] = 'Administrator/Employee/getEmployeePaymentLedger';

// new emplayee salary
$route['salaryGenerate'] = 'Administrator/Employee/employeeSalaryGenerate';
$route['generateEmployeeSalary'] = 'Administrator/Employee/generateEmployeeSalary';
$route['saveEmployeeSalary'] = 'Administrator/Employee/saveEmployeeSalary';
$route['get_employee_due'] = 'Administrator/Employee/getEmployeeDue';
$route['get_employee_payment_ledger'] = 'Administrator/Employee/getEmployeePaymentLedger';
...
$route['get_all_materials'] = 'Administrator/Material/getMaterialsName';
...
//recipe entry
$route['recipe_entry'] = 'Administrator/Production/recipeEntry';
$route['get_recipes'] = 'Administrator/Production/getRecipes';
$route['add_recipe'] = 'Administrator/Production/addRecipe';
$route['update_recipe'] = 'Administrator/Production/updateRecipe';
$route['delete_recipe'] = 'Administrator/Production/deleteRecipe';

// chalan
$route['purchase_chalan'] = 'Administrator/ChalanController';
$route['purchase_chalan/(:num)'] = 'Administrator/ChalanController/purchaseChalanEdit/$1';
$route['get_chalan_invoice'] = 'Administrator/ChalanController/getChalanInvoice';
$route['get_purchase_with_chalan'] = 'Administrator/ChalanController/getPurchaseWithChalan';
$route['save_purchase_chalan'] = 'Administrator/ChalanController/savePurchaseChalan';
$route['purchase_chalan_record'] = 'Administrator/ChalanController/purchaseChalanRecord';
$route['get_purchase_chalans'] = 'Administrator/ChalanController/getPurchaseChalans';
$route['get_purchase_chalan_without_details'] = 'Administrator/ChalanController/getPurchaseChalanWithoutDetails';
$route['get_purchase_chalan_by_id'] = 'Administrator/ChalanController/getPurchaseChalanById';
$route['get_purchase_chalan_with_details'] = 'Administrator/ChalanController/getPurchaseChalanWithDetails';
$route['delete_purchase_chalan'] = 'Administrator/ChalanController/deletePurchaseChalan';
$route['update_purchase_chalan'] = 'Administrator/ChalanController/updatePurchaseChalan';

// order 
$route['order_entry'] = 'Administrator/OrderController';
$route['delete_order'] = 'Administrator/OrderController/deleteOrder';
$route['save_order'] = 'Administrator/OrderController/saveOrder';
$route['get_order'] = 'Administrator/OrderController/getOrder';
$route['order_record'] = 'Administrator/OrderController/orderRecord';
$route['get_order_without_details'] = 'Administrator/OrderController/getOrderWithoutDetails';
$route['get_order_with_details'] = 'Administrator/OrderController/orderRecord';
$route['order_to_sale_convert'] = 'Administrator/OrderController/convertOrderToSale';
$route['order_invoice_print/(:num)'] = 'Administrator/OrderController/orderInvoicePrint/$1';

// customer 
$route['get_customer_wish_invoice'] = 'Administrator/Customer/getCustomerWishInvoice';
$route['get_invoice_wish_due'] = 'Administrator/Customer/getInvoiceWishDue';

// employee wise collection 
$route['empolyee_wise_collection_report'] = 'Administrator/Employee/employeeWiseCollectionReport';
$route['get_employee_wise_collection'] = 'Administrator/Employee/getEmployeeWiseCollectionReport';
